...
import { getCard, createCusNFT } from '../actions/action';
        ...
        <CustomDiv>
          ...
          <div className="input-div">
            ...
            <CustomInput
              ...
              type="number"
              value={nftData.value}
              onChange={(e) => setNftData({ ...nftData, value: Number(e.target.value) })}
            ></CustomInput>
          </div>
          ...
          <div className="input-div">
            ...
            <CustomInput
              ...
              value={nftData.info}
              onChange={(e) => {
                if (counterWord(e.target.value) <= 10) setNftData({ ...nftData, info: e.target.value });
              }}
            ></CustomInput>
          </div>
          <div className="button-div">
            <CusButton onClick={async () => await handleSave()}>Save</CusButton>

            <CusButton onClick={handleCancel}>Cancel</CusButton>
          </div>
        </CustomDiv>
        <PreviewDiv>
